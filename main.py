...
def loginScreen():
    ...
    lbl = Label(window, text="Enter  Master Password", font=("Helvetica", 14), fg="purple", bg="white")
    lbl.config(anchor=CENTER)
    lbl.pack()
    ...
    btn = Button(window, text="Submit", command=checkPassword, font=("Helvetica", 12), fg="white", bg="purple")
    btn.pack(pady=5)

    btn = Button(window, text="Reset Password", command=resetPassword, font=("Helvetica", 12), fg="white", bg="purple")
    btn.pack(pady=5)
...
def vaultScreen():
    ...
    lbl = Label(window, text="Password Vault", font=("Helvetica", 14), fg="purple", bg="white")
    lbl.grid(column=1)

    btn = Button(window, text="+", command=addEntry, fg="white", bg="purple")
    btn.grid(column=1, pady=10)

    lbl = Label(window, text="Website", font=("Helvetica", 14), fg="purple", bg="white")
    lbl.grid(row=2, column=0, padx=80)
    lbl = Label(window, text="Username", font=("Helvetica", 14), fg="purple", bg="white")
    lbl.grid(row=2, column=1, padx=80)
    lbl = Label(window, text="Password", font=("Helvetica", 14), fg="purple", bg="white")
    ...
    if (cursor.fetchall() != None):
        ...
        while True:
            ...
            lbl1 = Label(window, text=(decrypt(array[i][1], encryptionKey)), font=("Helvetica", 12), fg="purple", bg="white")
            lbl1.grid(column=0, row=(i + 3))
            lbl2 = Label(window, text=(decrypt(array[i][2], encryptionKey)), font=("Helvetica", 12), fg="purple", bg="white")
            lbl2.grid(column=1, row=(i + 3))
            lbl3 = Label(window, text=(decrypt(array[i][3], encryptionKey)), font=("Helvetica", 12), fg="purple", bg="white")
            lbl3.grid(column=2, row=(i + 3))

            btn = Button(window, text="Delete", command=partial(removeEntry, array[i][0]), font=("Helvetica", 12), fg="white", bg="purple")
